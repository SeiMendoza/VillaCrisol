...
class ClienteController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $request -> validate([
            'nombreCompleto'=> 'required|regex:/^[a-zA-Z\s\pLñÑ\.]+$/|max:50|min:3',
            ...
            'domicilio'=> 'required|regex:/^[a-zA-Z\pLñÑ\0-9\s\.,;:]+$/|min:4|max:150',
            ],[
            ...
            'domicilio.max'=> 'El domicilio debe tener maximo:150 letras' ,
   ...
   // muestra los detalles del cliente
    ...
    public function update(Request $request, $id){
        ...
        $request -> validate([
            ...
            'domicilio'=> 'required|regex:/^[a-zA-Z\0-9\s\pLñÑ.,;:]+$/|min:4|max:150',
            ],[
