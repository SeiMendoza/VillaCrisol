...
class CompraCreate extends Component
{
    ...
    protected $rules = [
        'data.numfactura' => 'regex',
        'data.proveedor' => 'regex',
        'data.fecha' => 'required',
    ...
    public function mount($id = null)
    {
        if ($id = null) {
            ...
            $this->data["numfactura"] = $this->compra->numfactura;
            $this->data["fecha"] = $this->compra->fecha;
            $this->data["descripcion"] = $this->compra->descripción;
            $this->data["proveedor"] = $this->compra->proveedor;
