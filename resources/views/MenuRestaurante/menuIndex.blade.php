...
<div class="container-fluid px-4">
    ...
    <div class="card shadow col-md-12" style="background: #1b6519;">
            ...
            <div style="display:block; float:left;">
                ...
                class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                    <div class="input-group" >
                        <input class="form-control" type="text" id="busqueda" name="busqueda" placeholder="Buscar por nombre o precio" aria-label="Buscar por nombre"
        ...
        <div class="card" style="color: #035700">
            ...
            <div class="" style=" height: 570px; overflow:scroll;  float:left;">
                <section class="container-fluid" style="">
                    <br>
                    <div class="tb" style="display: grid; grid-template-columns: 190px 190px 190px 190px 190px 190px; ">
                        @foreach ($menu as $m)
                        @if (($m->Activo)=="si")
                            <div class="" style="display:block; border:rounded; height: 260px; width: 155px; ">
                            ...
                            <div class="card" style="background-color: rgba(184, 184, 184, 0.511)">
                                ...
                                <div class="" style="text-align:center ;">
                                    <div class="text-center">
                                        ...
                                        <!-- precio-->
                                        <p class=""><strong> L. {{$c->Precio}}</strong></p>
                                        <div>
