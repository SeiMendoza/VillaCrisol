...
@section('title', 'Compras de animales')
...
<div class="container-fluid px-4">
    ...
    <div class="card shadow col-md-12">
        <div class="card-header" style="background: #25416b; color: white">
            <div>
                <h2 style=" text-align: center;" class="m-0 font-weight-bold">Lista de compras de animales</h2>
                </div><br>
            <div style="float: left; width: 500px;">
                <form action="{{ route('regcompraanimal.search') }}" method="get" role="search"
                class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            ...
                            <a href="{{route('regcompraanimal.index')}}" id="" class="btn btn-secondary">Borrar Busqueda</a>
            ...
            <div style="text-align: right">
                ...
                <a class="btn btn-primary" href="{{route('compraAnimal.create')}}">Nuevo</a>
            </div>
        </div>
  ...
  @forelse($compras as $compra)
    ...
    <th scope="col">{{$compra->id}}</th>
      <td scope="col">{{$compra->proveedor}}</td>
    <td scope="col">
